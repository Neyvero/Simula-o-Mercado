# Generated by Django 4.2.21 on 2025-06-02 20:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('historico', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='itens', to='mercado.historicocompra')),
            ],
        ),
        migrations.CreateModel(
            name='ItemCarrinho',
            fields=[
                ...
                ('carrinho', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='itens', to='mercado.carrinho')),
            ],
        ),
    ]
